...
# write.csv(df_wash16, "df_wash16_v05.csv")
...
write.csv(TrainingSet, "training_v05.csv")
write.csv(TestingSet, "testing_v05.csv")

TrainSet <- read.csv("training_v05.csv", header = TRUE)
TrainSet <- TrainSet[,-1]
