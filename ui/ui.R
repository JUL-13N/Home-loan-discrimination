...
visualization, and processing for financial and clinical environments.
...
social media, games, and cloud databases. I utilize Python, R (Shiny), Git, SQL, Java, and various 
languages and frameworks to create interactive web
applications that reveal big
data trends.
<br>
<br>
