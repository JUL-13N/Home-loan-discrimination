...
write.csv(df_wash16, "df_wash16_v02.csv")
...
write.csv(TrainingSet, "training_v02.csv")
write.csv(TestingSet, "testing_v02.csv")

TrainSet <- read.csv("training_v02.csv", header = TRUE)
TrainSet <- TrainSet[,-1]
